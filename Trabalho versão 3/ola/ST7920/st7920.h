...
#define	LCD_DDR						DDRD							//Direction register
#define	LCD_PORT					PORTD							//Port register
#define	LCD_CLK						6									//LCD Clock pin
#define	LCD_DATA					5									//LCD Data pin
#define	LCD_PWR						4									//LCD Power control pin
